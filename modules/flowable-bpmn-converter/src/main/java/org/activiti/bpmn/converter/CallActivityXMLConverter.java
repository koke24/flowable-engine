...
public class CallActivityXMLConverter extends BaseBpmnXMLConverter {
  ...
  protected BaseElement convertXMLToElement(XMLStreamReader xtr, BpmnModel model) throws Exception {
    ...
    callActivity.setInheritBusinessKey(Boolean.valueOf(xtr.getAttributeValue(ACTIVITI_EXTENSIONS_NAMESPACE, ATTRIBUTE_CALL_ACTIVITY_INHERITBUSINESSKEY)));
  ...
  protected void writeAdditionalAttributes(BaseElement element, BpmnModel model, XMLStreamWriter xtw) throws Exception {
    ...
    if (StringUtils.isNotEmpty(callActivity.getCalledElement())) {
      ...
      xtw.writeAttribute(ACTIVITI_EXTENSIONS_NAMESPACE, ATTRIBUTE_CALL_ACTIVITY_INHERITBUSINESSKEY, String.valueOf(callActivity.isInheritBusinessKey()));
    }
  }
